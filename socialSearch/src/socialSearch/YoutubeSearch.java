...
public class YoutubeSearch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.print("searchResponse  getNextPageToken "
			...
			SearchListResponse searchResponseNext = search.execute();

			List<SearchResult> searchResultNextList = searchResponseNext
					.getItems();

			if (searchResultNextList != null) {
				prettyPrint(searchResultNextList.iterator(), queryTerm);
			}
