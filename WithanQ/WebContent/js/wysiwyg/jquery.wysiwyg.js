...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;"></body></html>',
			...
			formWidth: 440,
			iFrameClass: null,
			initialContent: "<div id='holder' style='height: 1000px;'></div>",
		...
		this.init = function (element, options) {
			...
			javascript:(function(){var _readability_script=document.createElement('SCRIPT');_readability_script.type='text/javascript';_readability_script.src=baseHref+'/js/common/jquery-2.0.3.js?x='+(Math.random());var iframe = document.getElementById('wysiwyg-wysiwyg-iframe');var innerDoc = (iframe.contentDocument) ? iframe.contentDocument : iframe.contentWindow.document;innerDoc.getElementsByTagName('head')[0].appendChild(_readability_script);})();
			javascript:(function(){var _readability_script=document.createElement('SCRIPT');_readability_script.type='text/javascript';_readability_script.src=baseHref+'/js/common/dragDrop.js?x='+(Math.random());var iframe = document.getElementById('wysiwyg-wysiwyg-iframe');var innerDoc = (iframe.contentDocument) ? iframe.contentDocument : iframe.contentWindow.document;innerDoc.getElementsByTagName('head')[0].appendChild(_readability_script);})();
		};
