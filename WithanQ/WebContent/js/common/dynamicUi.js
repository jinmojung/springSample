...
var dynamicUi = {
	version : '0.0.1',
	apiProxyUrl: '../apiProxy',
	targetURL: '/API/MsEntireMessageList',
	maxColumn : 10,
	minColumn : 3,
	currentColumnCnt : -1,
	contentWidth : 300,
	...
	isNextPage : function() {
		var result = false;
		if(dynamicUi.getScrollRatio() < dynamicUi.nextPageScrollRatio){
			result = true;
		}
		return result;
	},
	 ...
	 * @return void
	 */
	getScrollTop : function(scrollRatio) {
		var htmlHeight = $(document).height() - $(window).height();
		var scrollTop = htmlHeight / (1 + scrollRatio);
		return scrollTop;
	},
	...
	getContentData : function(lastMsSeq) {
		if(!dynamicUi.isMakingContent){
    		...
    		dynamicUi.isMakingContent = true;
    		$.getJSON(dynamicUi.apiProxyUrl, {
    			targetURL : dynamicUi.targetURL,
